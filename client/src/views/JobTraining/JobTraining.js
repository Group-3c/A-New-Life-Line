...
import tmpImage from '../../assets/jobTraining.png';
import jwt from 'jsonwebtoken';
import axios from 'axios';

class JobTraining extends React.Component {

  //JobTraining has editable information by admin, so it's connected to backend
  constructor(props){
      super(props);
  ...
  async componentDidMount() {
      ...
      await axios.get('https://new-life-line.herokuapp.com/adminText/5ded23e76e6e5a2d10f00ae7')
        .then(response => {
          this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post('https://new-life-line.herokuapp.com/adminText/update/5ded23e76e6e5a2d10f00ae7', adminText)
